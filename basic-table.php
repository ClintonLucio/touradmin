					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix mb-20">
							<div class="pull-left">
								...
								<p><b>Click on reload button to access new ride requests</b></p>
							</div>
							<div class="pull-right">
								<button type="submit" id="getData" class="btn btn-primary ">Reload</button>
...
<div class="table-responsive">
	  ...
	  <tbody>
		...
		<script type="module">
			// Import the functions you need from the SDKs you need
			   ...
			   import { getDatabase,set, ref,push,child, onValue, update} from "https://www.gstatic.com/firebasejs/10.5.0/firebase-database.js";
			   import {getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, onAuthStateChanged } from "https://www.gstatic.com/firebasejs/10.5.0/firebase-auth.js";
				   ...
				   const firebaseConfig = {
					 apiKey: "AIzaSyBt1Y69dqAAepFZYPLaLmWDOdddSyHBszA",
					 authDomain: "tour-ghana-rental.firebaseapp.com",
					 databaseURL: "https://tour-ghana-rental-default-rtdb.firebaseio.com",
					 projectId: "tour-ghana-rental",
					 storageBucket: "tour-ghana-rental.appspot.com",
					 messagingSenderId: "1032834159295",
					 appId: "1:1032834159295:web:be2281231de29d55c36c0a",
					 measurementId: "G-KVMF6NZNDE"
				   };
 ...
 // 'users' is the name of the collection in the database
   ...
   getData.addEventListener('click',(e) =>{
	...
	const dbRef = ref(database, 'All Ride Requests/');
	...
	snapshot.forEach((childSnapshot) => {
		...
		// ...
      var row = "<tr><td>" + childData.userName + "</td><td>" + childData.userPhone + "</td><td>" + childData.destinationAddress +
		"</td><td>" + childData.userEmail + "</td><td>" + childData.pickupDate + "</td><td>" + childData.returnDate + 
